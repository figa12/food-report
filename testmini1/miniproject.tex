...
\hline
\step & Finish the searching by pressing back arrow  & The keyboard and word cloud disappears and a list of relevant recipes is shown \\
\hline
\end{testprocedure}
...
\hline
\step & Open navigation drawer and tab the ``Search by ingredient'' item  & The search by ingredient page opens \\
\hline
