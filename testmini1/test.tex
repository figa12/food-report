...
The preconditions specifies whether you should be signed in or not. If not specified, then it does not matter if you are signed in or not. This indirectly fulfils Requirement \ref{req:Nologinrequired} saying that login should not be required.
...
{\ref{req:recipesearch} Recipe search}
...
{Search and find recipe}
{Connected to the Internet, application opened}
{\ref{req:ingredientsearch} Ingredient search}
...
{User signed in}
{\ref{req:shoppinglist} Shopping list}
...
{Application is open, and user signed in}
{}
...
{Ingredients has been added to the shopping list, and user signed in}
{\ref{req:sharing} Sharing}
...
{Recipe sharing}
{Share a recipe}
{A recipe has been selected, and user signed in}
{\ref{req:sharing} Sharing}
...
{\ref{req:searchfilters} Search filter}
...
{Connected to the Internet, and user signed in}
{\ref{req:favourite} Favourites recipes}
...
{Not connected to the Internet, and user signed in}
{}
