...
The preconditions specifies if you should be signed in. If not specified, then it does not matter if you are signed in or not. This indirectly fulfils the requirement \ref{req:Nologinrequired} No login required.
