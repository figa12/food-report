This chapter will describe how the API has been implemented on the server aswell as how the search queries are designed and implemented.
\section{API}
\label{sec:com}
...
As seen in \autoref{lst:getIngredients} the method \inline{echoJson} is called. This method will encode the result into a \ac{json} formatted object and then print it. An example of result from a request to the server could look like the following:
