...
Our application has six top level views; ingredient search, recipe search, favourites, shopping list\todo{Should we still write "shopping list" even if we did not implement it}, settings, and sign in/sign out. 
