...
Our application has six top level views; ingredient search, recipe search, favourites, shopping list\todo{Should we still write this even if we did not implement the shopping list}, settings, sign in/sign out. we only have one lower level view which is a recipe. 