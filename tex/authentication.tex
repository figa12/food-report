...
It might seem redundant to send the hashed email every time and not just a user ID, but the mobile device is not required to have an Internet connection\todo{Internet or connection to the server?} to be able to sign in using Google+. 
