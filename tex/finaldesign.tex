...
When the user types, a list of suggestions will come up and the user can either press a suggestion to add the ingredient to the search, or press enter to add the first ingredient to the search. 
