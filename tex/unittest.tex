...
The goal was to achieve 100\% statement coverage of the \inline{DB} class and as seen in \appref{app:coverage} this was succeeded. Since all of the tests passes, we can be more confident that all of the functionality on the server works as intended. As long as the mobile application send the correct data of the correct format, we can ensure that a valid response is sent back.
