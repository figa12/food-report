...
\begin{description}
\item[Line 1] \inline{Pattern.Compile()} returns a compiled form of the regular expression. The regex matches the start of a string or a space and then the input itself. 
