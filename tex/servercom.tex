...
\begin{description}
\item[Lines 7-14] The constructor for \inline{ServerComTask}. It must have a \linebreak\inline{ServerAlertDialog} to display errors, and it must have an \inline{OnResponseListener} to send the result to.
