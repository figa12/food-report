...
Based on the early research of existing solutions and our problem definition we have come up with a list of requirements for our application. This list can be seen in this section.

\begin{enumerate}
  \item\label{req:android} \textbf{Android} \\
    The application must be able to run on Android version 4.3 and newer.\todo{Was it the SDK that confused you? We meant that it has to run on Android version 4.3 and newer, since this is what most new phones run.}
